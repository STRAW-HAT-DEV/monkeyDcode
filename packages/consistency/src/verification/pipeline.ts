...
export async function run(
    ...
    if (resolved.stages.includes("syntax")) {
    ...
    if (resolved.stages.includes("typecheck")) {
    ...
    if (resolved.stages.includes("lint")) {
    ...
    if (resolved.stages.includes("tests")) {
    ...
    if (resolved.stages.includes("test-generated")) {
    ...
    if (resolved.stages.includes("smoke")) {
