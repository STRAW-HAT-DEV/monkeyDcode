...
import { lazy } from "@monkeydcode/core/util/lazy"
...
import { NonNegativeInt, PositiveInt } from "@monkeydcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@monkeydcode/Pty") {}
