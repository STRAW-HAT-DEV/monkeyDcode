...
import { Hash } from "@monkeydcode/core/util/hash"
import { Plugin } from "../plugin"
import { serviceUse } from "@/effect/service-use"
import { type LanguageModelV3 } from "@ai-sdk/provider"
import * as ModelsDev from "@monkeydcode/core/models-dev"
import { Auth } from "../auth"
import { Env } from "../env"
import { InstallationVersion } from "@monkeydcode/core/installation/version"
...
import { optionalOmitUndefined } from "@monkeydcode/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@monkeydcode/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
export class Service extends Context.Service<Service, Interface>()("@monkeydcode/Provider") {}
