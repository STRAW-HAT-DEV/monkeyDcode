// @ts-nocheck
import type { JsonSchema, LLMRequest, ProviderMetadata } from "@monkeydcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@monkeydcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
  ...
  OpenAICompatible,
  OpenRouter,
} from "@monkeydcode/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @monkeydcode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
