...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@monkeydcode/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@monkeydcode/ToolRegistry") {}
